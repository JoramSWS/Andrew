...
def page_1():
    ...
    Answer the question in an angry, impatient tone.  Be sarcastic.  Be a man from Texas.  If you cannot come up with an answer, only say "Look, if you crap in one hand and wish in the other, I'll tell you which one fills up first": {question}
